...
export function DirectGoogleAuth({ onSignInSuccess, onSignInFailure }: DirectGoogleAuthProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Direct redirect to Google OAuth with proper Firebase project configuration
      ...
      console.log('[DirectGoogleAuth] Redirecting to Google OAuth:', googleAuthUrl);
      
      // Redirect to Google OAuth
      window.location.href = googleAuthUrl;
      
    } catch (error: any) {
      console.error('[DirectGoogleAuth] Error:', error);
      setIsLoading(false);
